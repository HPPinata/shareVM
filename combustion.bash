...
pass=$(ls -I xvda xvdd /dev/xvd*)
wipefs -f -a ${pass[@]} /dev/xvdd

bcache make -C /dev/xvdd
bcache register /dev/xvdd
sleep 1
...
echo '/var/share/mnt/vms  xcp-ng(rw,async,no_root_squash)' >> /etc/exports
